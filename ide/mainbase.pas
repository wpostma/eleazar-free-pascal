...
begin
  with MainIDEBar do begin
    ...
    begin
      ...
      CreateMenuItem(itmViewDebugWindows,itmViewMemViewer,'itmViewMemViewer',lisMenuViewMemViewer, 'debugger_memviewer');
...
begin
  with MainIDEBar do begin
    ...
    CreateMenuItem(ParentMI,itmRunMenuContinueLastStep,'itmRunMenuContinueLastStep',lisMenuContinueLastStep); //,'menu_continuestep');
